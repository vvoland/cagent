...
func TestTodoTool_Tools(t *testing.T) {
	...
	assert.Equal(t, "update_todo", tools[1].Function.Name)
	assert.Equal(t, "list_todos", tools[2].Function.Name)
	...
	updateProps := tools[1].Function.Parameters.Properties
	assert.Contains(t, updateProps, "id")
	assert.Contains(t, updateProps, "status")
	assert.Contains(t, tools[1].Function.Parameters.Required, "id")
	assert.Contains(t, tools[1].Function.Parameters.Required, "status")
